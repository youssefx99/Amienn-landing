        ...
        <Section title="Location & Contact">
          <div className="bg-surface-container-low border border-outline-variant p-6 space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="font-label text-xs text-on-surface-variant uppercase tracking-widest mb-1">Phone</div>
                <a href="tel:+201094263212" className="font-body text-sm text-primary underline hover:text-secondary transition-colors">
                  +20 1094263212
                </a>
              </div>
            </div>
